...
(async () => {
  ...
  const compressedHtml = path.resolve(__dirname, '_leadmagnet_v2_compressed.html');
  ...
  const pdfPath = path.resolve(__dirname, 'HALUCINATION_leadmagnet_v2_compressed.pdf');
  await page.pdf({
    path: pdfPath,
    format: 'A4',
  ...
  console.log(`Done: HALUCINATION_leadmagnet_v2_compressed.pdf (${sizeMB} MB)`);
