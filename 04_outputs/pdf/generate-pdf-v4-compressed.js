...
(async () => {
  ...
  const compressedHtml = path.resolve(__dirname, '_leadmagnet_v4_compressed.html');
  ...
  const pdfPath = path.resolve(__dirname, 'HALUCINATION_leadmagnet_v4_compressed.pdf');
  await page.pdf({
    path: pdfPath,
    format: 'A4',
  ...
  console.log(`Done: HALUCINATION_leadmagnet_v4_compressed.pdf (${sizeMB} MB)`);
