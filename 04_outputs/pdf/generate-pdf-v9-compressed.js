...
(async () => {
  ...
  const tmpHtml = path.resolve(__dirname, '_tmp_v9.html');
  ...
  const pdfPath = path.resolve(__dirname, 'HALUCINATION_leadmagnet_v9_compressed.pdf');
  await page.pdf({
    path: pdfPath,
    format: 'A4',
  ...
  console.log(`Done: HALUCINATION_leadmagnet_v9_compressed.pdf (${sizeMB} MB)`);
